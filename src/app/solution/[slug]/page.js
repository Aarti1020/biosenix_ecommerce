...
const softwaresData = {
  "captcha-solvex-software": {
   ...
   footer:"Start using Captcha Slovex today to manage captcha verification work efficiently and securely.",
...
export default function Page() {
  ...
  if (!software) {
    return (
      <section className="w-full min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-900 via-purple-800 to-indigo-900 text-white ">
        <p className="text-xl">Software not found for: <span className="text-yellow-400 font-bold">{slug}</span></p>
      </section>
    );
  }

  return (
    <section className="w-full min-h-screen bg-gradient-to-r from-indigo-900 via-purple-800 to-indigo-900 text-white px-6 py-17">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-start justify-between">
            ...
            <div className="space-y-2">
              {software.features.map((item, index) => (
                <div key={index} className="flex items-center gap-2">
                  <CheckCircle className="text-blue-300 w-5 h-5 shrink-0" />
                  <p>{item}</p>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div>
                <p className="text-sm text-gray-200 flex items-center gap-1">
                  <CalendarDays className="w-4 h-4" /> Subcription Validity
                </p>
              ...
              <div>
                <p className="text-sm text-gray-200 flex items-center gap-1">
                  <BadgeIndianRupee className="w-4 h-4" /> Software Fee
                </p>
        ...
        {/* RIGHT FORM */}
        <div className="w-full lg:w-96 max-w-md bg-white text-black rounded-xl p-6 shadow-xl border border-purple-300 shrink-0 mt-10">
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="flex flex-col">
              ...
              <select className="border border-gray-300 p-2 rounded-md outline-none focus:ring-2 focus:ring-blue-400">
          ...
          <button className="w-full bg-blue-500 text-white py-2.5 rounded-md mt-5 hover:bg-blue-600 transition font-medium cursor-pointer">
            Apply now
          </button>
